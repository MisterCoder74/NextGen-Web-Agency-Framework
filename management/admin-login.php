...
// Se l'admin è già loggato, reindirizza alla dashboard
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Carica i dati admin dal file JSON
    $admin_data = json_decode(file_get_contents('admin-credenti4ls.json'), true);
